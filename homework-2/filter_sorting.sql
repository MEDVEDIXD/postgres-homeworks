...
-- 2. уникальные страны и города, куда отправлялись заказы, отсортировать по странам
-- и городам (таблица orders, колонки ship_country, ship_city)
...
SELECT ship_country, AVG(shipped_date - order_date) AS days_difference
FROM orders
